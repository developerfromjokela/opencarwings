...
def get_weather_forecast(xml_data, returning_xml, channel_id, _):
    ...
    if (xml_data.get('base_info', None) is not None
        ...
        for daily_item in daily_forecast:
            daily_text += f"During the {daily_item['period']}, weather condition is gonna be, {daily_item['condition_txt']}. With temperature of {daily_item['temperature']} degrees celsius, wind speed of {daily_item['wind_speed']} meters per second and {daily_item['rain_chance']} percent chance of rain. \n"
        ...
        for weekly_item in weekly_forecast:
            ...
            weekly_text += f"On {weekday}, weather condition is gonna be, {weekly_item['condition_txt']}. With highest temperature of {weekly_item['temp_max']} degrees celsius, lowest temperature of {weekly_item['temp_min']} degrees celsius, wind speed of {weekly_item['wind_speed']} meters per second and {weekly_item['rain_chance']} percent chance of rain. \n"
